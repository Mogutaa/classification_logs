...
if __name__ == "__main__":
    ...
    print(classify_with_regex("File file.txt uploaded successfully by user user123."))
    ...
    print(classify_with_regex("Account with ID 123 created by user user123."))
    print(classify_with_regex("Opa pessoal, tudo bom?"))